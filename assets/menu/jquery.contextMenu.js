    ...
    var // currently active contextMenu trigger
      ...
      defaults = {
          ...
          classNames: {
              ...
              checked: 'context-menu-checked', // Item checked
      ...
      zindex = function ($t) {
          ...
          while (true) {
              zin = Math.max(zin, parseInt($tt.css('z-index'), 12) || 0);
              $tt = $tt.parent();
      ...
      op = {
          ...
          create: function (opt, root) {
              ...
              $.each(opt.items, function (key, item) {
                  ...
                  if (typeof item === 'string' || item.type === 'cm_separator' || /^--/.test(item.name || '')) {
          ...
          update: function (opt, root) {
              ...
              opt.$menu.children().each(function () {
                  var $item = $(this),
                    ...
                    checked = ($.isFunction(item.checked) && item.checked.call($trigger, key, root)) || item.checked === true,
                    visible;
                  ...
                  $item[checked ? 'addClass' : 'removeClass'](root.classNames.checked);
